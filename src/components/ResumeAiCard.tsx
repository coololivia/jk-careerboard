...
function ScoreStat({
  ...
  return (
    <div className="flex-1">
      ...
      <p className={`mt-0.5 text-[22px] font-bold leading-none ${numColor}`}>{value}%</p>
      <div className="mt-2 h-1.5 overflow-hidden rounded-full bg-jk-bg-section">
        <div
    ...
    <div className="card-tap rounded-[16px] bg-white p-4 border border-jk-border">
      ...
      <div className="flex items-start gap-6">
        ...
        <ScoreStat
          ...
          numColor={passStyle.numColor}
          barColor={passStyle.barColor}
        />
      </div>

      {/* AI 팁 */}
      <div className="mt-3 rounded-[10px] bg-jk-bg-blue px-3 py-2">
        <p className="text-[13px] font-semibold text-jk-blue leading-snug">
          {resume.tip}
        </p>
      </div>
